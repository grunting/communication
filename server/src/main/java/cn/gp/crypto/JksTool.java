...
public class JksTool {
    ...
    static {
        try {
            ...
            keyStore.load(
                    new FileInputStream(Configure.getConfigString(Constant.SERVER_JKS_PATH))
                    ,Configure.getConfigString(Constant.SERVER_JKS_KEYPASS).toCharArray());
            ...
            while(aliases.hasMoreElements()) {
                ...
                PrivateKey smallPrivateKey = (PrivateKey) keyStore.getKey(smallAlias, Configure.getConfigString(Constant.SERVER_JKS_STOREPASS).toCharArray());
