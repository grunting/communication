...
public class GroupServerImpl implements GroupServer {
    ...
    public GroupServerImpl(SimpleBasic simpleBasic, SimpleChannel simpleChannel, Channel channel){
    ...
    public byte[] createGroup01(String name, byte[] crypto) throws Exception {
        ...
        Group group = simpleBasic.getRemoteProxyObj(Group.class,clientBeanTarget);
